...
function dragOverHandler(self) {
  self.preventDefault();
}

function dropHandler(self) {
  self.preventDefault();
  var files = self.dataTransfer;
  handleMarkerUpload(files);
}
...
function handleMarkerUpload(self) {
    ...
    reader.onloadend = function () {
        ...
        MarkerModule.getFullMarkerImage(base64Data, 1, 512, "black")
...
function dragOverHandlerPhoto(self) {
  self.preventDefault();
}

function dropHandlerPhoto(self) {
  self.preventDefault();
  var files = self.dataTransfer;
